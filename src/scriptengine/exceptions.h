...
class DS_DLL_EXPORT dseInvalidClass : public duException{
...
class DS_DLL_EXPORT dseInvalidType : public duException{
...
class DS_DLL_EXPORT dseInvalidPrimitiveType : public duException{
...
class DS_DLL_EXPORT dseInvalidOnInterface : public duException{
...
class DS_DLL_EXPORT dseInvalidCast : public duException{
...
class DS_DLL_EXPORT dseInvalidSignature : public duException{
...
class DS_DLL_EXPORT dseInvalidOperator : public duException{
...
class DS_DLL_EXPORT dseClassNotNative : public duException{
...
class DS_DLL_EXPORT dseFunctionNotNative : public duException{
...
class DS_DLL_EXPORT dseInvalidTypeModifier : public duException{
...
class DS_DLL_EXPORT dseNextObjectExisting : public duException{
...
class DS_DLL_EXPORT dseInvalidStatement : public duException{
...
class DS_DLL_EXPORT dseScriptedException : public duException{
...
class DS_DLL_EXPORT dseEngineLocked : public duException{
...
class DS_DLL_EXPORT dseNoScriptLoaded : public duException{
...
class DS_DLL_EXPORT dseInvalidSyntax : public duException{
...
class DS_DLL_EXPORT dseInvalidCode : public duException{
...
class DS_DLL_EXPORT dseDirectoryNotFound : public duException{
...
class DS_DLL_EXPORT dseDirectoryRead : public duException{
