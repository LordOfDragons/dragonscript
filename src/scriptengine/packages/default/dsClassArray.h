...
// class dsClassArray
class DS_DLL_EXPORT dsClassArray : public dsClass {
private:
	dsClass *p_ClsObj;
public:
...
#define DEF_NATFUNC(name) \
	...
	DEF_NATFUNC( nfForEachCastable2 );
	DEF_NATFUNC( nfForEachCastable3 );
	DEF_NATFUNC( nfForEachReverseCastable );
	DEF_NATFUNC( nfForEachWhileCastable );
	DEF_NATFUNC( nfForEachWhileCastable2 );
	DEF_NATFUNC( nfForEachWhileCastable3 );
	DEF_NATFUNC( nfForEachWhileReverseCastable );
	DEF_NATFUNC( nfMap );
	DEF_NATFUNC( nfMap2 );
	DEF_NATFUNC( nfMap3 );
	...
	DEF_NATFUNC( nfCollectCastable2 );
	DEF_NATFUNC( nfCollectCastable3 );
	DEF_NATFUNC( nfCollectReverseCastable );
	DEF_NATFUNC( nfFold );
	DEF_NATFUNC( nfFold2 );
	DEF_NATFUNC( nfFold3 );
	...
	DEF_NATFUNC( nfCountCastable2 );
	DEF_NATFUNC( nfCountCastable3 );
	DEF_NATFUNC( nfCountReverseCastable );
	DEF_NATFUNC( nfFind );
	DEF_NATFUNC( nfFind2 );
	DEF_NATFUNC( nfFind3 );
	DEF_NATFUNC( nfFindReverse );
	DEF_NATFUNC( nfFindCastable );
	DEF_NATFUNC( nfFindCastable2 );
	DEF_NATFUNC( nfFindCastable3 );
	DEF_NATFUNC( nfFindReverseCastable );
