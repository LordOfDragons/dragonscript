...
#ifndef _DSCLASSOBJECTBOOL_H_
#define _DSCLASSOBJECTBOOL_H_
...
/**
 * \brief Immutable bool object class.
 * 
...
public:
	...
	dsClassObjectBoolean();
	
	/** \brief Clean up script class. */
	virtual ~dsClassObjectBoolean();
	/*@}*/
